...
export default (() => {
	return <Theme theme={theme}>
		...
		<Components.Header />
		<Section background="rgba(0, 0, 0, 0) url(https://uploads.quarkly.io/600e0aca11b69c001f4aa723/images/Advice.jpg?v=2021-01-29T22:37:50.668Z) 0% 0% /cover repeat scroll padding-box" sm-padding="150px 0 60px 0" padding="180px 0 120px 0">
		...
		<Section sm-padding="30px 0 30px 0" lg-padding="50px 0 50px 0" md-padding="20px 0 20px 0" padding="40px 0 70px 0">
				...
				<StackItem width="100%">
					...
					<Components.Tabs2 defaultTab="one" display="flex" width="100%" md-flex-direction="column">
						...
						<Override
							...
							width="30%"
						/>
						<Override slot="Tab one" background="#EEF2F3" border-radius="5px 5px 0px 0px">
							Resume
						</Override>
						...
						<Components.Tab2 tabId="one" width="100%">
							<Box>
								<Text font="36px 'AvenirNextCyrRegular'" margin="0px 0px 16px 0px" sm-text-align="center" color="#263238">
									Resume
								</Text>
								...
								<Text margin="24px 0px 4px 0px" font="24px/30px 'AvenirNextCyrMedium', sans-serif" color="#333">
									Resume requirements
									<br />
								</Text>
							...
							<Text color="#333" sm-text-align="center" font="24px/30px 'AvenirNextCyrMedium', sans-serif">
								Tell us more
								<br />
							</Text>
							<Text font="18px/26px 'AvenirNextCyrRegular', sans-serif" color="#333" sm-text-align="center">
						...
						<Components.Tab2 tabId="three">
							<Box>
								...
								<Text color="#333" margin="20px 0px 16px 0px" sm-text-align="center" font="24px/30px 'AvenirNextCyrMedium', sans-serif">
		...
		<Section sm-padding="60px 0 60px 0" lg-padding="40px 0 40px 0" background="#eef2f3" padding="60px 0 60px 0">
			<Override slot="SectionContent" align-items="center" />
			<Stack margin="0px 0px 0px 0px" max-width="1170px" width="100%">
				...
				<StackItem width="33.333%" lg-width="50%" sm-width="100%">
					<Override
						...
						flex-direction="column"
					/>
					<Text margin="0px 0px 16px 0px" font="normal 400 48px/54px 'AvenirNextCyrMedium', sans-serif" color="#aec1d9" padding="0px 0px 0px 0px">
						01
					</Text>
					<Text
				...
				<StackItem width="33.333%" lg-width="50%" sm-width="100%">
					<Override
						...
						sm-align-items="center"
					/>
					<Text padding="0px 0px 0px 0px" margin="0px 0px 16px 0px" font="normal 400 48px/54px 'AvenirNextCyrMedium', sans-serif" color="#aec1d9">
						05
					</Text>
					<Text
						margin="0px 0px 16px 0px"
